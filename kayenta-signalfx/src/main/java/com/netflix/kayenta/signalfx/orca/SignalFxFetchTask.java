...
public class SignalFxFetchTask implements RetryableTask {
    ...
    @SuppressWarnings("Duplicates") // Seems to be the pattern in the code base to have this code duplicated, I assume to prevent independent implementations from being tightly coupled,
    @Nonnull
    @Override
